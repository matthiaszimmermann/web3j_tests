...
public final class Fibonacci extends Contract {
    ...
    public static class NotifyEventResponse {
        ...
        @Override
        public int hashCode() {
        	return input.getValue().hashCode() + result.getValue().hashCode();
        }
        
        @Override
        public boolean equals(Object obj) {
        	if(obj == null) return false;
        	if(!(obj instanceof NotifyEventResponse)) return false;
        	
        	NotifyEventResponse other = (NotifyEventResponse)obj;
        	return input.equals(other.input) && result.equals(other.result);
        }
    }
}
